...
namespace hasty {
	namespace expr {
		...
		export UnityToken operator-(const ZeroToken& a, const NegUnityToken& b);
		export NegUnityToken operator-(const ZeroToken& a, const UnityToken& b);
		...
		export ZeroToken operator-(const NegUnityToken& a, const NegUnityToken& b);
		export NumberToken operator-(const NegUnityToken& a, const UnityToken& b);
		...
		export NumberToken operator-(const UnityToken& a, const NegUnityToken& b);
		export ZeroToken operator-(const UnityToken& a, const UnityToken& b);
		...
		{
			return NumberToken(-2.0f, false, util::broadcast_tensor_shapes(a.sizes, b.sizes));
		}
		...
		{
			return NumberToken(-b.num - 1.0f, b.is_imaginary, util::broadcast_tensor_shapes(a.sizes, b.sizes));
		}
		...
		{
			return NumberToken(1.0f - b.num, b.is_imaginary, util::broadcast_tensor_shapes(a.sizes, b.sizes));
		}
		...
		{
			return NumberToken(a.num + 1.0f, a.is_imaginary, util::broadcast_tensor_shapes(a.sizes, b.sizes));
		}
